...
const ReviewCard = ({user}:Props) => {
  return (
    <div className='bg-white shadow-md dark:bg-gray-800 rounded-lg m-3 
    p-6 relative '>
      ...
      <p className='mt-6 text-base text-gray-800 dark:text-gray-300 font-semibold'>{user.review}</p>
