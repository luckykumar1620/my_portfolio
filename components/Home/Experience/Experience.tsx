    ...
    return (
        <div id='experience' className='py-16 bg-gray-100 dark:bg-gray-950 '>
            <SectionHeading
                title_1='Experience & '
                title_2='Education'
                description='An overview of my academic background, hands-on experience, and the journey that shaped my skills as a developer'
            />
                          ...
                          <div className='ml-16 md:ml-0 md:w-[calc(50%-2rem)]'>
                            ...
                            transition-all duration-300'>
                                <div className='flex items-center gap-2 text-sm text-blue-500 mb-2'>
                                    <span className='px-3 py-1 rounded-full bg-blue-600/10 '>
                                    {item.period}
                                    </span>
                                </div>
