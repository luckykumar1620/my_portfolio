    ...
    <div className={`transition-all ${navBg ? "dark:bg-gray-800 bg-white shadow-md ":"fixed"} duration-200 h-[12vh] z-[100] fixed w-full`}>
      <div className='flex items-center h-full justify-between w-[90%] xl:w-[80%] mx-auto'>
        ...
        <div className='hidden lg:flex items-center space-x-8'>
          {Navlinks.map((link, index) => (
            <Link
              ...
              dark:hover:text-yellow-200 font-semibold transition-all duration-200'
            >
              <p>{link.name}</p>
            </Link>
          ))}
        ...
        <div className='flex items-center space-x-4'>
          ...
          <a
            href="#_"
            className=' lg:inline-flex box-border z-20 relative items-center justify-center w-auto
