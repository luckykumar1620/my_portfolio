...
const Footer = () => {
  return <footer className='border-t bg-white dark:bg-gray-900 border-gray-200 
        ...
        <div className='flex flex-col md:flex-row items-center justify-between gap-6'>
            <a href="#home" className='text-xl font-bold text-indigo-700'>
                ...
                <div className='flex items-center gap-4 '>
                    {footerSocialLinks.map((link,label)=>{
                        return (
                        <a href={link.href} key={link.label} 
                        target='_blank'
                         rel='noopener noreferrer' 
                         className='w-10 h-10 rounded-lg bg-white dark:bg-gray-800 shadow-md
